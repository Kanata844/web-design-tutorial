...
<div>
    ...
    <h2 style:margin-bottom="10px">Cloudflare Pagesとは</h2>
    ...
    <h2><a href={resolve("/vite-ts/page1")}>1.ViteでTypeScriptで開発信</a></h2>
    <h2><a href={resolve("/astro/page1")}>2.Astroで開発</a></h2>
